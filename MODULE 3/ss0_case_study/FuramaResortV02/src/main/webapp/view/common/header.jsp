...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div style="width: 1200px; text-align: end">
        <h6 style="color: black">Nguyễn Xuân Long </h6>
    </div>
</nav>
...
<nav class="navbar navbar-expand-lg navbar-light " style="background-color: #0f5132">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#" style="color: white">Customer</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#" style="color: white">Service</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#" style="color: white">Contract</a>
            </li>
<%--            <li class="nav-item">--%>
