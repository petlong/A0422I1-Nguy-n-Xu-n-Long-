...
//
//    @Pointcut(
////            "execution(* com.bookss09.service.impl.BookServiceImpl.update(..)) ||" +
////            "execution(* com.bookss09.service.impl.BookServiceImpl.create(..)) ||" +
//            "execution(* com.example.book.service.impl.BookServiceImpl.updateAmountBook(..))"
//    )
...
//    }
//
//    @Pointcut("execution(* com.example.book.service.impl.BookServiceImpl.*(..))")
